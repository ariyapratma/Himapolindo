...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO calek (judul_calek, thumbnail_calek, konten_calek, tanggal_calek, id_login) VALUES ('$judul_calek', '$target_file', '$deskripsi', NOW(), '$id_login')";
...
<head>
    <meta charset="utf-8" />
    <title>Tambah Catatan Intelektual | Himapolindo</title>
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi calek di sini...'
            });
