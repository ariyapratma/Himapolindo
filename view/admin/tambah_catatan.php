...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO calek (judul_calek, thumbnail_calek, konten_calek, tanggal_calek) VALUES ('$judul_calek', '$target_file', '$deskripsi', NOW())";
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content" style="margin-left: 250px;">
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Tambah Catatan Intelektual</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_rakernas.php">Lihat Catatan Intelektual</a></li>
                                        <li class="breadcrumb-item active">Tambah Catatan Intelektual</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <form id="calekForm" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul Catatan Intelektual</label>
                                <textarea class="form-control" name="judul_calek" rows="3"></textarea>
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi catatan intelektual di sini...'
            });

            $('#calekForm').on('submit', function(event) {
