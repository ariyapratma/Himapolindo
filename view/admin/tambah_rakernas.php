...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO rakernas (judul_rakernas, thumbnail_rakernas, konten_rakernas, tanggal_rakernas, id_login) VALUES ('$judul_rakernas', '$target_file', '$deskripsi', NOW(), '$id_login')";
...
<head>
    <meta charset="utf-8" />
    <title>Tambah Rakernas | Himapolindo</title>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content" style="margin-left: 250px;">
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Tambah Rakernas</h4>
                ...
                <form id="rakernasForm" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul Rakernas</label>
                                <textarea class="form-control" name="judul_rakernas" rows="3"></textarea>
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi rakernas di sini...'
            });

            $('#rakernasForm').on('submit', function(event) {
