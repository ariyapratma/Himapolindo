...
<head>
    <meta charset="utf-8" />
    <title>Komentar Dies Natalis | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Dies Natalis</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_dies_natalis.php">Lihat Dies Natalis</a></li>
                                        <li class="breadcrumb-item active">Komentar Dies Natalis</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                // Query untuk mengambil data komentar dari diesnatalis himapolindo beserta informasi diesnatalis himapolindo yang berkaitan
                                $sql = "SELECT k.id_komentar, d.judul_diesnatalis, k.nama, k.komentar FROM komentar_diesnatalis k JOIN diesnatalis d ON k.id_diesnatalis = d.id_diesnatalis";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada komentar untuk Dies Natalis.</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_dies_natalis.php?id=' + id;
                }
            })
        }
    </script>
