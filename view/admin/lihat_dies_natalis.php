...
<head>
    <meta charset="utf-8" />
    <title>Lihat Dies Natalis | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Lihat Dies Natalis</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_dies_natalis.php">Dies Natalis</a></li>
                                        <li class="breadcrumb-item active">Lihat Dies Natalis</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                $sql = "SELECT id_diesnatalis, judul_diesnatalis, thumbnail_diesnatalis FROM diesnatalis";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>" . $no++ . "</td>";
                                        echo "<td>" . $row['judul_diesnatalis'] . "</td>";
                                        echo "<td><img src='../../images/uploads/" . $row['thumbnail_diesnatalis'] . "' style='width: 100%; height: auto;'/></td>";
                                        echo "<td><a href='edit_dies_natalis.php?id=" . $row['id_diesnatalis'] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                        echo "<a href='javascript:void(0)' onclick='confirmDeletion(" . $row['id_diesnatalis'] . ")' class='btn btn-danger btn-sm'>Hapus</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
                    ...
                    function confirmDeletion(id) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = 'hapus_dies_natalis.php?id=' + id;
                            }
                        })
                    }
                </script>
