    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content" style="margin-left: 250px;">
            <div class="page-content">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Tambah Ravelnas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <form id="ravelnasForm" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul Ravelnas</label>
                                <textarea class="form-control" name="judul_ravelnas" rows="3"></textarea>
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi ravelnas di sini...'
            });

            $('#ravelnasForm').on('submit', function(event) {
