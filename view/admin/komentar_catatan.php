...
<head>
    <meta charset="utf-8" />
    <title>Komentar Catatan Intelektual | Himapolindo</title>
                ...
                <div style="overflow-x : scroll;">
                    <table class="table table-hover tablesorter" id="myTableUtama">
                        ...
                        <tbody id="myTable">
                            ...
                            $sql = "SELECT k.id_komentar, d.judul_calek, k.nama, k.komentar FROM komentar_calek k JOIN calek d ON k.id_calek = d.id_calek";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5'>Tidak ada komentar untuk Calek Himapolindo.</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
