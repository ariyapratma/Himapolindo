...
<head>
    <meta charset="utf-8" />
    <title>Komentar Rakernas | Himapolindo</title>
            ...
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Rakernas</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_rakernas.php">Lihat Rakernas</a></li>
                                        <li class="breadcrumb-item active">Komentar Rakernas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div style="overflow-x : scroll;">
                    <table class="table table-hover tablesorter" id="myTableUtama">
                        ...
                        <tbody id="myTable">
                            <?php
                            // Query untuk mengambil data komentar dari rakernas himapolindo beserta informasi rakernas himapolindo yang berkaitan
                            $sql = "SELECT k.id_komentar, d.judul_rakernas, k.nama, k.komentar FROM komentar_rakernas k JOIN rakernas d ON k.id_rakernas = d.id_rakernas";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5'>Tidak ada komentar untuk Rakernas Himapolindo.</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_rakernas.php?id=' + id;
                }
            })
        }
    </script>
