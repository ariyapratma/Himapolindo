...
<head>
    <meta charset="utf-8" />
    <title>Komentar Galeri | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Galeri</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_galeri.php">Lihat Galeri</a></li>
                                        <li class="breadcrumb-item active">Komentar Galeri</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                // Query untuk mengambil data komentar dari galeri himapolindo beserta informasi galeri himapolindo yang berkaitan
                                $sql = "SELECT k.id_komentar, d.judul_galeri, k.nama, k.komentar FROM komentar_galeri k JOIN galeri d ON k.id_galeri = d.id_galeri";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada komentar untuk Galeri.</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_galeri.php?id=' + id;
                }
            })
        }
    </script>
