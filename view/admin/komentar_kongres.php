...
<head>
    <meta charset="utf-8" />
    <title>Komentar Kongres | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Kongres Himapolindo</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_kongres.php">Lihat Kongres Himapolindo</a></li>
                                        <li class="breadcrumb-item active">Komentar Kongres Himapolindo</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                // Query untuk mengambil data komentar dari kongres himapolindo beserta informasi kongres himapolindo yang berkaitan
                                $sql = "SELECT k.id_komentar, d.judul_kongres, k.nama, k.komentar FROM komentar_kongres k JOIN kongres d ON k.id_kongres = d.id_kongres";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada komentar untuk Kongres Himapolindo.</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_kongres.php?id=' + id;
                }
            })
        }
    </script>
