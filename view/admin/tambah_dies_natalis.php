...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO diesnatalis (judul_diesnatalis, thumbnail_diesnatalis, konten_diesnatalis, tanggal_diesnatalis) VALUES ('$judul_diesnatalis', '$target_file', '$deskripsi', NOW())";
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi dies natalis di sini...'
            });
