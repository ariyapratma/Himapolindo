...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO diesnatalis (judul_diesnatalis, thumbnail_diesnatalis, konten_diesnatalis, tanggal_diesnatalis, id_login) VALUES ('$judul_diesnatalis', '$target_file', '$deskripsi', NOW(), '$id_login')";
...
<head>
    <meta charset="utf-8" />
    <title>Tambah Dies Natalis | Himapolindo</title>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content" style="margin-left: 250px;">
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Tambah Dies Natalis</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_dies_natalis.php">Lihat Dies Natalis</a></li>
                                        <li class="breadcrumb-item active">Tambah Dies Natalis</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <form id="diesnatalisForm" action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul Dies Natalis</label>
                                <textarea class="form-control" name="judul_diesnatalis" rows="3"></textarea>
    ...
    <script>
        $(document).ready(function() {
            var quillDeskripsi = new Quill('#deskripsi_editor', {
                theme: 'snow',
                placeholder: 'Isi deskripsi diesnatalis di sini...'
            });

            $('#diesnatalisForm').on('submit', function(event) {
