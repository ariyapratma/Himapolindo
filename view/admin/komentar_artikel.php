...
<head>
    <meta charset="utf-8" />
    <title>Komentar Artikel | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Artikel</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_artikel.php">Lihat Artikel</a></li>
                                        <li class="breadcrumb-item active">Komentar Artikel</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                // Query untuk mengambil data komentar dari artikel himapolindo beserta informasi artikel himapolindo yang berkaitan
                                $sql = "SELECT k.id_komentar, d.judul_artikel, k.nama, k.komentar FROM komentar_artikel k JOIN artikel d ON k.id_artikel = d.id_artikel";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='5'>Tidak ada komentar untuk Artikel Himapolindo.</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_artikel.php?id=' + id;
                }
            })
        }
    </script>
