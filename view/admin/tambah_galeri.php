...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["userfile"]["tmp_name"][0], $target_file)) {
            $sql = "INSERT INTO galeri (judul_galeri, thumbnail_galeri, konten_galeri, tanggal_galeri, id_login) VALUES ('$judul_galeri', '$target_file', '$deskripsi', NOW(), '$id_login')";
...
<head>
    <meta charset="utf-8" />
    <title>Tambah Galeri | Himapolindo</title>
