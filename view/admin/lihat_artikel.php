...
<head>
    <meta charset="utf-8" />
    <title>Lihat Artikel | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Lihat Artikel</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_artikel.php">Artikel</a></li>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                $sql = "SELECT id_artikel, judul_artikel, thumbnail_artikel FROM artikel";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><img src='../../images/uploads/" . $row['thumbnail_artikel'] . "' style='width: 100%; height: auto;'/></td>";
                                        echo "<td><a href='edit_artikel.php?id=" . $row['id_artikel'] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                        echo "<a href='javascript:void(0)' onclick='confirmDeletion(" . $row['id_artikel'] . ")' class='btn btn-danger btn-sm'>Hapus</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
