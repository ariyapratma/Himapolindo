            ...
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Lihat Rakernas</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item">Rakernas</a></li>
                                        <li class="breadcrumb-item active">Lihat Rakernas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div style="overflow-x : scroll;">
                    <table class="table table-hover tablesorter" id="myTableUtama">
                        ...
                        <tbody id="myTable">
                            <?php
                            $sql = "SELECT id_rakernas, judul_rakernas, thumbnail_rakernas FROM rakernas";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td><img src='../../images/uploads/" . $row['thumbnail_rakernas'] . "' style='width: 100%; height: auto;'/></td>";
                                    echo "<td><a href='edit_rakernas.php?id=" . $row['id_rakernas'] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                    echo "<a href='javascript:void(0)' onclick='confirmDeletion(" . $row['id_rakernas'] . ")' class='btn btn-danger btn-sm'>Hapus</a></td>";
                                    echo "</tr>";
                                }
                            } else {
                ...
                function confirmDeletion(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'hapus_rakernas.php?id=' + id;
                        }
                    })
                }
            </script>
