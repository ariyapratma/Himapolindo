...
<head>
    <meta charset="utf-8" />
    <title>Lihat Galeri | Himapolindo</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Lihat Galeri</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_galeri.php">Galeri</a></li>
                                        <li class="breadcrumb-item active">Lihat Galeri</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-x : scroll;">
                        <table class="table table-hover tablesorter" id="myTableUtama">
                            ...
                            <tbody id="myTable">
                                <?php
                                $sql = "SELECT id_galeri, judul_galeri, thumbnail_galeri FROM galeri";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>" . $no++ . "</td>";
                                        echo "<td>" . $row['judul_galeri'] . "</td>";
                                        echo "<td><img src='../../images/uploads/" . $row['thumbnail_galeri'] . "' style='width: 100%; height: auto;'/></td>";
                                        echo "<td><a href='edit_galeri.php?id=" . $row['id_galeri'] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                        echo "<a href='javascript:void(0)' onclick='confirmDeletion(" . $row['id_galeri'] . ")' class='btn btn-danger btn-sm'>Hapus</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
