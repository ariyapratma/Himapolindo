            ...
            <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Komentar Ravelnas</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lihat_ravelnas.php">Lihat Ravelnas</a></li>
                                        <li class="breadcrumb-item active">Komentar Ravelnas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div style="overflow-x : scroll;">
                    <table class="table table-hover tablesorter" id="myTableUtama">
                        ...
                        <tbody id="myTable">
                            <?php
                            // Query untuk mengambil data komentar dari ravelnas himapolindo beserta informasi ravelnas himapolindo yang berkaitan
                            $sql = "SELECT k.id_komentar, d.judul_ravelnas, k.nama, k.komentar FROM komentar_ravelnas k JOIN ravelnas d ON k.id_ravelnas = d.id_ravelnas";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5'>Tidak ada komentar untuk Ravelnas Himapolindo.</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapus_komentar_ravelnas.php?id=' + id;
                }
            })
        }
    </script>
