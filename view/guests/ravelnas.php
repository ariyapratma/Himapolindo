...
// Query untuk mengambil data ravelnas
        ...
        <div class="row">
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <a href="detailbacaanravelnas.php?id=' . $row['id_ravelnas'] . '" class="card-link" onclick="increaseViews(' . $row['id_ravelnas'] . ')">
                <div class="card">
            ...
            // Jika tidak ada data
            echo '<p>Tidak ada data ravelnas.</p>';
          }
          ?>
        </div>
      </div>
