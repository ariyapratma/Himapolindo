...
$query = "SELECT *, DATE_FORMAT(tanggal_diesnatalis, '%d %M %Y') AS tanggal_upload FROM diesnatalis WHERE id_diesnatalis = $id";
$result = mysqli_query($conn, $query);

if ($result && mysqli_num_rows($result) > 0) {
  $row = mysqli_fetch_assoc($result);
  $judul = htmlspecialchars($row['judul_diesnatalis']);
  $deskripsi = htmlspecialchars($row['konten_diesnatalis']);
  $thumbnail = htmlspecialchars($row['thumbnail_diesnatalis']);
  ...
  $judul = "Data dies natalis tidak ditemukan.";
  $deskripsi = "";
  $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_diesnatalis WHERE id_diesnatalis = ?";
...
<head>
  ...
  <title>Detail Dies Natalis | Himapolindo</title>
...
<body>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p>
              ...
              <i class="fas fa-folder"></i> <a href="diesnatalishimapolindo.php">Dies Natalis Himapolindo</a> |
  ...
  <div class="comment-section pb-40" id="comments">
    ...
    <div id="commentCarousel" class="carousel slide" data-ride="carousel">
      <?php
      $query_komentar = "SELECT * FROM komentar_diesnatalis WHERE id_diesnatalis = ?";
  ...
  <center>
    <div class="comment-section pb-40">
      <form class="comment-form" method="POST" action="proses_komentar_diesnatalis.php">
        <h2> KOMENTAR</h2>
        <input type="hidden" name="id_diesnatalis" value="<?php echo $id; ?>">
