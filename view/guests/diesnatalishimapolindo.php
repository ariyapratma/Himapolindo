...
// Query untuk mengambil data diesnatalis
        ...
        <div class="row">
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <a href="detailbacaandiesnatalis.php?id=' . $row['id_diesnatalis'] . '" class="card-link" onclick="increaseViews(' . $row['id_diesnatalis'] . ')">
                <div class="card">
            ...
            // Jika tidak ada data
            echo '<p>Tidak ada data dies natalis.</p>';
          }
          ?>
        </div>
      </div>
