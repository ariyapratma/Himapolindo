      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-4">
            <img src="../../assets_guests/images/logo/logo-profil.png" alt="Logo Profil">
          </div><!-- /col-lg-4 -->
          <div class="col-sm-12 col-md-12 col-lg-8">
            <h3 class="heading__title">About Us</h3>
            <p class="heading__desc mb-30">
              Himpunan Mahasiswa Ilmu Politik (HIMAPOL) Indonesia merupakan organisasi yang 
              ...
              Republik Indonesia. 
              Himapol Indonesia terdiri dari 6 Koordinator wilayah, dimana Koordinator Wilayah 1 
              berada diwilayah Aceh, Koordinator Wilayah 2 berada di wilayah Sumatera Raya, 
              Koordinator Wilayah 3 berada di wilayah (Jawa Barat, Jakarta, Banten, dan Kalimantan 
              Barat), kemudian di Koordinator Wilayah 4 berada di wilayah DIY & Jawa Tengah, 
              Koordinator Wilayah 5 berada di wilayah Sulawesi, dan Koordinator Wilayah 6 berada di 
              wilayah (Jawa Timur, Nusa Tenggara, dan Papua).
            </p>
          </div><!-- /col-lg-8 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
