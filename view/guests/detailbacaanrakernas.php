...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $judul = htmlspecialchars($row['judul_rakernas']);
    ...
    $judul = "Data rakernas tidak ditemukan.";
    $deskripsi = "";
    $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_rakernas WHERE id_rakernas = ?";
...
<head>
    ...
    <title>Detail Rakernas | Himapolindo</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p>
                            ...
                            <i class="fas fa-folder"></i> <a href="rakernas.php">Rakernas</a> |
