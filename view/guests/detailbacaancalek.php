...
$query = "SELECT *, DATE_FORMAT(tanggal_calek, '%d %M %Y') AS tanggal_upload FROM calek WHERE id_calek = $id";
$result = mysqli_query($conn, $query);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $judul = htmlspecialchars($row['judul_calek']);
    $deskripsi = htmlspecialchars($row['konten_calek']);
    $thumbnail = htmlspecialchars($row['thumbnail_calek']);
    ...
    $judul = "Data calek tidak ditemukan.";
    $deskripsi = "";
    $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_calek WHERE id_calek = ?";
...
<head>
    ...
    <title>Detail Catatan Intelektual | Himapolindo</title>
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p>
                            ...
                            <i class="fas fa-folder"></i> <a href="catatanintelektual.php">Catatan Intelektual</a> |
    ...
    <div class="comment-section pb-40" id="comments">
        ...
        <div id="commentCarousel" class="carousel slide" data-ride="carousel">
            <?php
            $query_komentar = "SELECT * FROM komentar_calek WHERE id_calek = ?";
    ...
    <center>
        <div class="comment-section pb-40">
            <form class="comment-form" method="POST" action="proses_komentar_catatan.php">
                <h2> KOMENTAR</h2>
                <input type="hidden" name="id_calek" value="<?php echo $id; ?>">
