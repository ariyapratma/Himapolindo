...
// Query untuk mengambil data kongres
        ...
        <div class="row">
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <a href="detailbacaankongres.php?id=' . $row['id_kongres'] . '" class="card-link" onclick="increaseViews(' . $row['id_kongres'] . ')">
                <div class="card">
            ...
            // Jika tidak ada data
            echo '<p>Tidak ada data kongres.</p>';
          }
          ?>
        </div>
      </div>
