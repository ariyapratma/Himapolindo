...
$query = "SELECT *, DATE_FORMAT(tanggal_galeri, '%d %M %Y') AS tanggal_upload FROM galeri WHERE id_galeri = $id";
$result = mysqli_query($conn, $query);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $judul = htmlspecialchars($row['judul_galeri']);
    $deskripsi = htmlspecialchars($row['konten_galeri']);
    $thumbnail = htmlspecialchars($row['thumbnail_galeri']);
    ...
    $judul = "Data galeri tidak ditemukan.";
    $deskripsi = "";
    $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_galeri WHERE id_galeri = ?";
...
<head>
    ...
    <title>Detail Galeri | Himapolindo</title>
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p>
                            ...
                            <i class="fas fa-folder"></i> <a href="galeri.php">Galeri</a> |
    ...
    <div class="comment-section pb-40" id="comments">
        ...
        <div id="commentCarousel" class="carousel slide" data-ride="carousel">
            <?php
            $query_komentar = "SELECT * FROM komentar_galeri WHERE id_galeri = ?";
    ...
    <center>
        <div class="comment-section pb-40">
            <form class="comment-form" method="POST" action="proses_komentar_galeri.php">
                <h2> KOMENTAR</h2>
