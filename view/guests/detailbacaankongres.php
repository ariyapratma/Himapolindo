...
$query = "SELECT *, DATE_FORMAT(tanggal_kongres, '%d %M %Y') AS tanggal_upload FROM kongres WHERE id_kongres = $id";
$result = mysqli_query($conn, $query);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $judul = htmlspecialchars($row['judul_kongres']);
    $deskripsi = htmlspecialchars($row['konten_kongres']);
    $thumbnail = htmlspecialchars($row['thumbnail_kongres']);
    ...
    $judul = "Data kongres tidak ditemukan.";
    $deskripsi = "";
    $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_kongres WHERE id_kongres = ?";
...
<head>
    ...
    <title>Detail Kongres | Himapolindo</title>
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p>
                            ...
                            <i class="fas fa-folder"></i> <a href="kongreshimapolindo.php">Kongres Himapolindo</a> |
    ...
    <div class="comment-section pb-40" id="comments">
        ...
        <div id="commentCarousel" class="carousel slide" data-ride="carousel">
            <?php
            $query_komentar = "SELECT * FROM komentar_kongres WHERE id_kongres = ?";
    ...
    <center>
        <div class="comment-section pb-40">
            <form class="comment-form" method="POST" action="proses_komentar_kongres.php">
                <h2> KOMENTAR</h2>
                <input type="hidden" name="id_kongres" value="<?php echo $id; ?>">
