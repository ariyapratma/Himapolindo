...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $judul = htmlspecialchars($row['judul_ravelnas']); // Menggunakan htmlspecialchars untuk mencegah XSS
    ...
    $judul = "Data Ravelnas Himapolindo tidak ditemukan.";
    $deskripsi = "";
...
<body>
    ...
    ========================= -->
        ...
        <div class="comment-section pb-40">
            <h2>KOMENTAR</h2>
            <?php
            // Query untuk mengambil komentar dari database berdasarkan id_ravelnas
