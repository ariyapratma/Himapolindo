...
$query = "SELECT *, DATE_FORMAT(tanggal_ravelnas, '%d %M %Y') AS tanggal_upload FROM ravelnas WHERE id_ravelnas = $id";
$result = mysqli_query($conn, $query);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $judul = htmlspecialchars($row['judul_ravelnas']);
    $deskripsi = htmlspecialchars($row['konten_ravelnas']);
    $thumbnail = htmlspecialchars($row['thumbnail_ravelnas']);
    ...
    $judul = "Data ravelnas tidak ditemukan.";
    $deskripsi = "";
    $thumbnail = "";
}

// Get the number of comments
$query_comments = "SELECT COUNT(*) as jumlah_komentar FROM komentar_ravelnas WHERE id_ravelnas = ?";
...
<head>
    ...
    <title>Detail Ravelnas | Himapolindo</title>
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p>
                            ...
                            <i class="fas fa-folder"></i> <a href="ravelnas.php">Ravelnas</a> |
    ...
    <div class="comment-section pb-40" id="comments">
        ...
        <div id="commentCarousel" class="carousel slide" data-ride="carousel">
            <?php
            $query_komentar = "SELECT * FROM komentar_ravelnas WHERE id_ravelnas = ?";
    ...
    <center>
        <div class="comment-section pb-40">
            <form class="comment-form" method="POST" action="proses_komentar_ravelnas.php">
                <h2> KOMENTAR</h2>
                <input type="hidden" name="id_ravelnas" value="<?php echo $id; ?>">
