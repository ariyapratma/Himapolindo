...
// Query untuk mengambil data rakernas
        ...
        <div class="row">
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <a href="detailbacaanrakernas.php?id=' . $row['id_rakernas'] . '" class="card-link" onclick="increaseViews(' . $row['id_rakernas'] . ')">
                <div class="card">
            ...
            // Jika tidak ada data
            echo '<p>Tidak ada data rakernas.</p>';
          }
          ?>
        </div>
      </div>
